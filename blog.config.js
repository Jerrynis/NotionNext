...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jerrynis', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一只老鼠🐭', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bog.jerrycloud.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,Jerry', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://img.picui.cn/free/2025/04/23/6808e1d104a72.jpg', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  GREETING_WORDS:
    ...
    '泥嚎，欢迎来到我的博客🎉,Hello，欢迎莅临Jerrynisの博客❤️',
